...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-right', speed: 750, intensity: 5, delay: 0, replay: false });
		...
		onvisible.add('.buttons.style2', { style: 'fade-up', speed: 1000, intensity: 4, delay: 0, replay: false });
		onvisible.add('h1.style9, h2.style9, h3.style9, p.style9', { style: 'fade-left', speed: 1000, intensity: 5, delay: 0, replay: false });
